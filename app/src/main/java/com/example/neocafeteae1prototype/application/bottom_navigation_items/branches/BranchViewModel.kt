...
class BranchViewModel : ViewModel() {
    ...
    val list = listOf<AllModels.NeoCafePlace>(
            AllModels.NeoCafePlace("https://media-cdn.tripadvisor.com/media/photo-s/1a/2b/ea/41/photo0jpg.jpg", "Панфиолова 55", "9:00 - 22: 00", "https://go.2gis.com/ih9kh", workTimeList, "0777652485", testBranchInfo,neobisFacebook, neobisInstagram ),
